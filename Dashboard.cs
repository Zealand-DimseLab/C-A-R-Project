...
public class Dashboard : MonoBehaviour
{
    ...
    public void ConfirmOverride()
    {
        ...
        pulseSender.SetParticipantID(pid);
...
//         allLogsCheckImg.color = allFilesExists ? Color.green : Color.red;
//
//         bool gotParticipantID = pulseSender.ParticipantId == "PENDING" ? false : true;
//         startSessionButtonObj.SetActive(headSetCheckImg.color == Color.green && allLogsCheckImg.color == Color.green && gotParticipantID);
//     }
//
//     public static bool startedSim = false;
//
...
//
//     public void StartPulseBridge(){
//         System.Diagnostics.Process.Start("D:\\CarProjektDiverse\\WAHOOV2\\wahoo-ble-sniffer\\starters\\START_ALL.bat");
//     }
// }
